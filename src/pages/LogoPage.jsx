...
const projects = [
  ...
  },
  {
    ...
    images: ['/images/LOGO/04.png', '/images/LOGO/clown_skull.gif'],
  },
  {
    title: 'Cloud Plates',
    rows: [
...
function ProjectSlide({ project, index }) {
  ...
  return (
    <div
      ref={ref}
      className={`${shared.slide} ${visible ? shared.slideVisible : ''}`}
    >
      <table className={shared.infoTable}>
        <tbody>
          <tr>
            <th className={shared.projectTitle} style={{ whiteSpace: 'pre-line' }}>
              {project.title}
            </th>
            <th />
            <th>
