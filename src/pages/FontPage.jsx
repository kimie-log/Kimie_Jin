...
const projects = [
  { title: '活動海報字體設計', rows: [], images: ['/images/font/01.png'] },
  { title: 'LOGO字體設計',     rows: [], images: ['/images/font/02.png'] },
  { title: '文創藝術字體設計', rows: [], images: ['/images/font/03.png'] },
  { title: '貼文字體設計',     rows: [], images: ['/images/font/04.png'] },
]
